...
import random
amount_of_fruit = int(input("how many fruits do you want.  theres like five or six avaible. : "))
fruits = ["appel", "bannanna", "stauwberrary", "goat eyes", "invisible chair", "pumkpink"]
for i in range(amount_of_fruit) :
    fruit = random.choice(fruits)
    print("You got the : ",fruit)